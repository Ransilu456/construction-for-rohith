    ...
    return (
        <main className="min-h-screen flex flex-col bg-background selection:bg-primary/20">
            ...
            <section className="pt-32 lg:pt-52 pb-16 md:pb-24 max-w-7xl mx-auto px-6 w-full text-center">
                ...
                <h1 className="text-4xl md:text-7xl font-heading font-light tracking-tight text-foreground mb-8">What We Do.</h1>
                <p className="text-base md:text-xl font-light leading-relaxed max-w-3xl mx-auto text-foreground/70">
            ...
            <section className="pb-24 md:pb-32">
                <div className="max-w-[1400px] mx-auto px-6 w-full space-y-20 md:space-y-24">
                    {services.map((service, idx) => (
                        <div key={service.id} id={service.id} className={`flex flex-col ${idx % 2 === 1 ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-10 md:gap-16 lg:gap-24`}>
                            ...
                            <div className="w-full lg:w-1/2 lg:py-12">
                                ...
                                <h2 className="text-2xl md:text-4xl font-heading font-light text-foreground mb-6">{service.title}</h2>
                                <p className="text-foreground/70 text-base md:text-lg font-light leading-relaxed mb-8 md:mb-10">
                                    {service.desc}
                                </p>
